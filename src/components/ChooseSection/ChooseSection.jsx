  ...
  return (
    <div>
      <div className="container">
        <h2 className="text-center mb-5">Why choose Eden?</h2>
        <div className="row g-4">
            ...
            <Card className="d-flex align-items-center border-0 h-100">
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  Academic honors, athletic achievements, research awards and
                  recognition for contributions to the university community.{" "}
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          <div className="col-lg-4">
            <Card className="d-flex align-items-center border-0 h-100">
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  We're committed to maintain a positive and satisfying
                  experience for our students within an educational institution.{" "}
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          <div className="col-lg-4">
            <Card className="d-flex align-items-center border-0 h-100">
              ...
              <Card.Body>
                <Card.Title className="text-center text-capitalize mb-3">
                  3 locations in Morocco
                </Card.Title>
                <Card.Text className="text-center">
                  Our three main campuses—in Casablanca, Rabat, Fes, are a home
                  to students and faculty, a hub of research and innovation, and
